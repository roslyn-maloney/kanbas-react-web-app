export default function BootstrapGrids() {
    return (
      <div>
        ...
        <h1>Screen Modifier</h1>
        <div className="row">
          <div className="col-1 bg-warning">Side bar</div>
          <div className="col-11 bg-primary">Main content</div>
        </div>
        <div className="row">
          <div className="col-2 bg-warning">Side bar</div>
          <div className="col-10 bg-primary">Main content</div>
        </div>
        <div className="row">
          <div className="col-3 bg-warning">Side bar</div>
          <div className="col-9 bg-primary text-white">Main content</div>
        </div>
        <div className="row">
          <div className="col-4 bg-warning">Side bar</div>
          <div className="col-8 bg-primary text-white">Main content</div>
        </div>
        <div className="row">
          <div className="col-12 bg-warning">Side bar</div>
        </div>
        <br />
        <div className="row">
          <div className="col-md-2 col-xxl-3 bg-warning">
            <h3>Side bar</h3>
          </div>
          <div className="col-md-4 col-xxl-6 bg-primary text-white">
            <h3>Main content</h3>
          </div>
          <div className="col-md-6 col-xxl-3 bg-success text-white">
            <h3>Side bar</h3>
          </div>
        </div>
